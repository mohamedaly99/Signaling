...
import 'package:rentina/views/signin/widgets/detailWidget.dart';
import 'package:rentina/services/api/reviews/getReviews.dart';
...
class CarItem extends StatelessWidget {
  ...
  CarItem(this.userId,this.carId, this.distance, this.fuelLevel, this.image, this.modelName,
